...
export class ResetPasswordComponent implements OnInit {
  ...
  ressetPassword() {
    ...
    this.authenticationService.resetPassword(req).subscribe((res: ApiResponse) => {
  ...
  showHidePassword(type: string) {
    if (type === this.REENTERPASSWORD_FIELD) {
      ...
      this.typeInputReEnterPassword = !this.showReEnterPassword ? "password" : "text";
    }
    else {
  ...
  missMatchPassword() {
    ...
    const valReEnterPassword = this.resetPasswordForm.get('reEnterPassword')?.value;
